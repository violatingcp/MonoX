...
def generateMonoJet(mass,med,width,process,gq,gdm,lhe):
   ...
   os.system('cp -r /afs/cern.ch/user/p/pharris/pharris/public/bacon/Darkmatter/MCFM-6.8_v3/Bin .')
   os.chdir('Bin')
   ...
   if process > 830 and process < 840:
      process2=process-30
      os.system('./runYuk.sh %d %d %d %d %d %d' % (med,mass,width,process2,gq,gdm))
   os.chdir('..')
